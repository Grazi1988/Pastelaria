...
//método setInterval está executadndo uma ação
 const PararSetInterval= setInterval(()=>{
...
//Criando uma função para Parar o estado 'parar', chamandoo método clearInterval para parar oestado.

const PararContagem = () => clearInterval (pause)
